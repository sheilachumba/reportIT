...
$router->get('/verify-email', [App\Controllers\AuthController::class, 'verifyEmail']);
$router->get('/verify-email/resend', [App\Controllers\AuthController::class, 'resendVerification']);
...
$router->get('/admin/report', [App\Controllers\AdminController::class, 'report']);
